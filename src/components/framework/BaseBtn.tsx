    ...
    render() {
        return (
            <form className="form-inline">
                ...
                <button type="button" id="btn-delete" className="btn btn-danger glyphicon glyphicon-plus">
                    <span className="btn-val-svg">
                ...
                <button type="button" id="btn-edit" className="btn btn-warning glyphicon glyphicon-plus">
                    <span className="btn-val-svg">
                ...
                <button type="button" id="btn-info" className="btn btn-info glyphicon glyphicon-plus">
                    <span className="btn-val-svg">
